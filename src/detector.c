...
static void
print_cocos(FILE *fp, char *image_path, box *boxes, float **probs, int num_boxes, int classes, int w, int h) {
    int i, j;
...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh) {
    ...
    while (1) {
        ...
        //读入的图片原始数据写入到文件中
//        FILE *fp = fopen("/home/zxd/data/layer_output/image", "wb+");
//        if (!fp) {
//            printf("file open error");
//            return;
//        }
//        fwrite(im.data, sizeof(float), im.c * im.h * im.w, fp);
//        fclose(fp);
...
//            return;
//        }
//        fwrite(sized.data, sizeof(float), sized.c * sized.h * sized.w, fp);
//        fclose(fp);
